...
public class DirectMlInferenceBackend : IInferenceBackend
{
    private InferenceSession? _session;
    public string Name => "DirectML (GPU/NPU Fallback)";
    public InferenceBackendKind Kind => InferenceBackendKind.DirectMl;
    ...
    public Task<InferenceResult> PredictAsync(FeatureSequence sequence, CancellationToken ct = default)
    {
        ...
        {
            throw new InvalidOperationException("DirectML backend is not initialized or not available.");
        }
